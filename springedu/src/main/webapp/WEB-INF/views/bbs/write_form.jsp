...
<div class="container">
	...
	<h3 class="text-center p-3 mb-3 "">글쓰기</h3>
		<form:form modelAttribute="bbsDTO" action="/bbs/writeok" >
			...
			<table class="table  table-sm" summary="글쓰기">
				...
				<tbody>
					<tr>
						<th>제목</th>
						<td>
							<form:input class="form-control is-valid" path="btitle"  type="text" placeholder="제목을 입력하세요.(30자 이하)"/>
